  ...
  test(
    ...
    async () => {
      ...
      await th.user(TEST_USER_ID).sendMessage({
        content: 'PERMISSION_TYPING_MARKER add-directory-flow',
      })
      ...
      expect(timeline).toMatchInlineSnapshot(`
        ...
        *project ⋅ main ⋅ Ns ⋅ N% ⋅ deterministic-v2*
        ...
        \`/Users/morse\`
        Kimaki will auto-accept matching external directory requests for \`/Users/morse/*\` in this thread.
        --- from: user (add-directory-tester)
        PERMISSION_TYPING_MARKER add-directory-flow
        --- from: assistant (TestBot)
